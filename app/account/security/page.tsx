...
export default function SecurityPage() {
  ...
  //
  //  🔴href="/account" 를 박지 않는다. 구독을 안 파는 동안 next.config.ts 가
  //    /account 를 홈으로 돌려보내므로(?preview 가 없으면 307), 그렇게 하면
  //    [취소]가 사람을 홈으로 내던진다. 뒤로 가기면 ?preview 든 무엇이든
  //    **방금 있던 그 화면** 그대로 돌아간다. 히스토리가 없을 때만(주소를 직접
  //    치고 들어온 경우) /account 로 보낸다.
  // ==========================================================================
  const back = () => {
