...
const TX = {
  ...
  en: {
    ...
    leadSet: "Right now you can only log in with Google. Set a password and you can log in with your email address too.",
    ...
    doneChange: "Your password has been changed. From your next login, use {email} and the new password.",
    doneSet: "Your password is set. You can now log in with {email} and this password, as well as with Google.",
