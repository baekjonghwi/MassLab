  ...
  en: {
    wallAndSlab: {
      ...
      params: [
        ...
        { label: "WALL", desc: "Must be perpendicular to the XY plane. Open Brep not allowed\nIt is recommended that the ratio of the wall thickness to the original wall thickness be similar to the SCALE\n(to prevent the wall from protruding beyond the SLAB)" },
        { label: "SLAB", desc: "Must be horizontal to the XY plane. Open Brep not allowed\nIt is recommended that the ratio of SLAB thickness to the original SLAB thickness be similar to the SCALE\n(e.g. original SLAB thickness = 300mm, SCALE = 1/100 → SLAB thickness = 3mm)" },
