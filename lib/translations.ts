export const t = {
  en: {
    ...
    review: {
      ...
      desc: "Upload a photo of your result and write a short review to receive a 100% refund.",
      photoLabel: "Photo",
      ...
      accountPlaceholder: "e.g. 1234-5678-9012",
      submit: "Submit Review",
      submitting: "Submitting...",
      successTitle: "Thank you!",
      successDesc: "Your review has been submitted. We'll process your refund shortly.",
  ...
  ko: {
    ...
    review: {
      title: "후기 작성",
      desc: "결과물이 나온 사진을 넣고, 간단한 후기를 작성해주시면 비용 100%를 환급해 드립니다.",
      photoLabel: "사진",
      ...
      bankLabel: "은행명",
      bankPlaceholder: "예: 카카오뱅크",
      accountLabel: "계좌번호",
      accountPlaceholder: "예: 1234-5678-9012",
      submit: "후기 제출",
      submitting: "제출 중...",
      successTitle: "감사합니다!",
      successDesc: "후기가 접수되었습니다. 곧 환급을 처리해 드리겠습니다.",
