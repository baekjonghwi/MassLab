export const t = {
  en: {
    ...
    // ⛔건당결제 화면의 글(payment · paymentComplete)과 결제 뒤에 뜨던 후기 폼의 글(review)은
    //   2026-09-14 에 화면과 함께 지웠다. 지금 후기 폼은 제품 쪽에 있다(lib/reviews 머리 주석).
    contact: {
      title: "Contact",
    ...
    privacy: {
      ...
      sections: [
        ...
        },
        {
          ...
          // 🔴결제사(토스페이먼츠·갤럭시아·엑심베이)는 적지 않는다 — 포트원을 거쳐 가므로
