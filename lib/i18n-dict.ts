...
const M: Record<string, Six> = {
  ...
  "Monthly uses": ["月間回数", "每月次数", "Usos mensuales", "Usos mensais", "Utilisations mensuelles", "Nutzungen pro Monat"],
  "/mo": ["/月", "/月", "/mes", "/mês", "/mois", "/Monat"],
  "Couldn't open checkout. Please try again shortly.": ["決済画面を開けませんでした。しばらくしてからもう一度お試しください。", "无法打开支付页面，请稍后再试。", "No se pudo abrir el pago. Inténtalo de nuevo en unos momentos.", "Não foi possível abrir o pagamento. Tente novamente dentro de momentos.", "Impossible d'ouvrir le paiement. Réessayez dans un instant.", "Die Zahlung konnte nicht geöffnet werden. Bitte versuchen Sie es gleich noch einmal."],
  "KRW prices include 10% VAT and are converted at the exchange rate on the day of payment.": ["ウォン価格は付加価値税10%込みで、決済時点の為替レートで換算されます。", "韩元价格含10%增值税，按付款当日汇率换算。", "Los precios en KRW incluyen un 10% de IVA y se convierten al tipo de cambio del día del pago.", "Os preços em KRW incluem 10% de IVA e são convertidos à taxa de câmbio do dia do pagamento.", "Les prix en KRW incluent 10 % de TVA et sont convertis au taux de change du jour du paiement.", "KRW-Preise enthalten 10 % MwSt. und werden zum Wechselkurs am Zahlungstag umgerechnet."],
