...
const M: Record<string, Six> = {
  ...
  "Sections": ["セクション移動", "章节导航", "Secciones", "Secções", "Sections", "Abschnitte"],
  ...
  "My Plan": ["ご利用プラン", "我的订阅", "Mi plan", "O meu plano", "Mon offre", "Mein Tarif"],
  ...
  "Pick a tool and start right there. One account, one plan.": ["使いたい道具を選べば、その場で始まります。アカウントも料金もひとつです。", "选好工具即刻开始。一个账号，一种方案。", "Elige una herramienta y empieza ahí mismo. Una cuenta, un plan.", "Escolha uma ferramenta e comece ali mesmo. Uma conta, um plano.", "Choisissez un outil et commencez tout de suite. Un compte, une offre.", "Werkzeug wählen und sofort loslegen. Ein Konto, ein Tarif."],
  ...
  "Plans": ["料金プラン", "订阅方案", "Planes", "Planos", "Formules", "Tarife"],
  ...
  // ── 내 계정 ────────────────────────────────────────────────────────────
  "My subscription": ["ご利用プラン", "我的订阅", "Mi suscripción", "A minha subscrição", "Mon abonnement", "Mein Abonnement"],
  "Sign out": ["ログアウト", "退出登录", "Cerrar sesión", "Terminar sessão", "Se déconnecter", "Abmelden"],
  ...
  "Close account": ["退会", "注销账号", "Eliminar cuenta", "Eliminar conta", "Supprimer le compte", "Konto löschen"],
  ...
  "Are you sure? Confirming this deletes your account right away.": ["本当に退会しますか？ この確認でアカウントは直ちに削除されます。", "确定要注销吗？确认后账号会立即删除。", "¿Seguro? Al confirmar, tu cuenta se elimina de inmediato.", "Tem a certeza? Ao confirmar, a conta é eliminada de imediato.", "Êtes-vous sûr ? En confirmant, votre compte est supprimé immédiatement.", "Sind Sie sicher? Mit der Bestätigung wird Ihr Konto sofort gelöscht."],
  ...
  "Right now you can only sign in with Google. Set a password and you can sign in with your email address too.": ["いまは Google ログインのみ利用できます。パスワードを決めると、メールアドレスでもログインできます。", "目前只能用 Google 登录。设置密码后，也可以用邮箱登录。", "Ahora mismo solo puedes iniciar sesión con Google. Si defines una contraseña, también podrás entrar con tu correo.", "Neste momento só pode iniciar sessão com o Google. Se definir uma palavra-passe, também poderá entrar com o seu e-mail.", "Pour l'instant, vous ne pouvez vous connecter qu'avec Google. Définissez un mot de passe pour vous connecter aussi avec votre e-mail.", "Derzeit können Sie sich nur mit Google anmelden. Legen Sie ein Passwort fest, dann geht es auch per E-Mail-Adresse."],
  ...
  "For safety, please sign in again before changing your password.": ["安全のため、もう一度ログインしてから変更してください。", "为了安全，请重新登录后再修改。", "Por seguridad, vuelve a iniciar sesión antes de cambiar la contraseña.", "Por segurança, inicie sessão novamente antes de alterar a palavra-passe.", "Par sécurité, reconnectez-vous avant de changer votre mot de passe.", "Bitte melden Sie sich aus Sicherheitsgründen erneut an, bevor Sie das Passwort ändern."],
  "Your sign-in has expired. Please sign in again.": ["ログインの有効期限が切れました。もう一度ログインしてください。", "登录已过期，请重新登录。", "Tu sesión ha caducado. Inicia sesión de nuevo.", "A sua sessão expirou. Inicie sessão novamente.", "Votre session a expiré. Veuillez vous reconnecter.", "Ihre Anmeldung ist abgelaufen. Bitte erneut anmelden."],
  ...
  // ── 로그인·가입 ────────────────────────────────────────────────────────
  "Sign in": ["ログイン", "登录", "Iniciar sesión", "Iniciar sessão", "Connexion", "Anmelden"],
  ...
  "Google sign-in isn't available right now.": ["Google ログインは現在ご利用いただけません。", "当前无法使用 Google 登录。", "El inicio de sesión con Google no está disponible ahora mismo.", "O início de sessão com o Google não está disponível de momento.", "La connexion Google n'est pas disponible pour le moment.", "Die Google-Anmeldung ist derzeit nicht verfügbar."],
  "Country": ["お住まいの国", "居住国家", "País de residencia", "País de residência", "Pays de résidence", "Wohnsitzland"],
  "Select your country": ["国を選択してください", "请选择国家", "Selecciona tu país", "Selecione o seu país", "Sélectionnez votre pays", "Land auswählen"],
  "Please select your country.": ["国を選択してください。", "请选择国家。", "Selecciona tu país.", "Selecione o seu país.", "Veuillez sélectionner votre pays.", "Bitte wählen Sie Ihr Land."],
  ...
  "Back to sign in": ["ログインに戻る", "返回登录", "Volver a iniciar sesión", "Voltar a iniciar sessão", "Retour à la connexion", "Zurück zur Anmeldung"],
  ...
  "We use it to set your billing currency and tax handling. You can change it later.": ["決済通貨と税の扱いを決めるために使います。あとから変更できます。", "用于确定结算币种和税务处理。之后可以修改。", "Lo usamos para fijar tu moneda de pago y el tratamiento fiscal. Puedes cambiarlo más adelante.", "Usamos isto para definir a moeda de pagamento e o tratamento fiscal. Pode alterar mais tarde.", "Nous l'utilisons pour définir votre devise de paiement et le traitement fiscal. Vous pourrez le modifier plus tard.", "Wir legen damit Ihre Abrechnungswährung und die Steuerbehandlung fest. Später änderbar."],
  ...
  // ── 라이노 기기 연결 ───────────────────────────────────────────────────
  "Device connected": ["接続しました", "已连接", "Dispositivo conectado", "Dispositivo ligado", "Appareil connecté", "Gerät verbunden"],
  ...
  "Account": ["アカウント", "账号", "Cuenta", "Conta", "Compte", "Konto"],
  ...
  "This plan isn't available right now.": ["現在販売していないプランです。", "该方案目前不销售。", "Este plan no está disponible ahora mismo.", "Este plano não está disponível de momento.", "Cette formule n'est pas disponible pour le moment.", "Dieser Tarif ist derzeit nicht verfügbar."],
